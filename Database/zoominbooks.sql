...
-- Χρόνος δημιουργίας: 04 Ιουλ 2016 στις 11:36:33
...
(10, '960-412-064-6', 'Ένας πολύ γλυκός… λύκος', 'Λήδα Βαρβαρούση', 'Λήδα Βαρβαρούση', 'ΠΑΠΑΔΟΠΟΥΛΟΣ', 22, 30, 4, 6, b'0', 'likos.cover.jpg', 'likos.back.jpg', 'vfsd', 8, b'1', b'0', b'0', 'Notice the WHERE clause in the DELETE syntax: The WHERE clause specifies which record or records that should be deleted. If you omit the WHERE clause, all records will be deleted!', b'1'),
(11, '960-423-424-2', 'Η Μίλι, η Μόλι και η πρώτη τους μέρα στο σχολείο  Milly and Molly’s Mo', 'Gill Pittar', 'Cris Morrell', 'Σαββάλας Milly Molly Books', 31, 15, 3, 5, b'0', 'moli.cover.jpg', 'moli.back.jpg', '', 7, b'1', b'0', b'0', '', b'1'),
...
(15, '960-8365-32-5', 'Το μικρό χωριό στο βουνό', 'Αντώνης Παπαθεοδούλου', 'παιδιά', 'Ταξιδευτής', 24, 30, 3, 5, b'1', 'xorio.cover.jpg', 'xorio.back.jpg', '', 12, b'1', b'0', b'0', '', b'1'),
...
--
ALTER TABLE `keywords`
  MODIFY `Keyword_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=206;
--
