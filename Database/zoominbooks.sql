...
-- Χρόνος δημιουργίας: 16 Ιουν 2016 στις 09:34:48
...
(15, 'Δεν χρειάζεται να νικήσεις για να απολαύσεις το παιχνίδι', 1),
(16, 'Αποδοχή και ενδυνάμωση εαυτού- αυτοεικόνα, αυτοεκτίμηση, αυτοπεποίθηση', 1),
(17, 'Αντιμετώπιση φόβων', 1),
(18, 'Βιβλία, γνώση = δύναμη, αποτροπή χειραγώγησης από άλλους', 1),
...
(29, 'Σχολικός εκφοβισμός – Bullying ', 3),
(30, 'Θύμα', 3),
(31, 'Θύτης', 3),
(32, 'Αποφυγή καυγά', 3),
...
(91, 'Μονόλογος', 12),
(92, 'Διάλογος', 12),
(93, 'Κυριολεξία – μεταφορά – κυριολεξοποίηση της μεταφοράς', 12),
(94, 'Επανάληψη', 12),
(95, 'Μοτίβο', 12),
(96, 'Ενεστώτας', 13),
(97, 'Παρελθόν', 13),
...
(101, 'Μέλλον', 13),
(102, 'Στιγμιαίος/Συνοπτικός ', 13),
(103, 'Εξακολουθητικός', 13),
(104, 'Συντελεσμένος', 13),
(105, 'ενικός-πληθυντικός', 14),
(106, '(εγώ, εσύ, αυτός) – ορθογραφία καταλήξεων', 15),
(107, 'Προστακτική', 18),
(108, 'Υποτακτική', 18),
...
(129, 'Υποκοριστικά', 21),
(130, 'Προθέματα', 21),
(131, 'Παραλλαγές λέξεων- αυτοσχέδιες λέξεις – επανανακάλυψη γλώσσας', 21),
...
(150, 'Χτίσιμο σπιτιών από διαφορετικά υλικά', 25),
...
(170, 'Αρχέτυπο – κανόνας των τριών', 29),
(171, 'Χριστούγεννα', 30),
...
--
ALTER TABLE `keywords`
  MODIFY `Keyword_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=176;
--
